    ...
    <div className='px-4 sm:px-20 xl:px-32 my-24'> 
        ...
        <div className='flex flex-wrap mt-10 justify-center'> 
            ...
            {AiToolsData.map((tool,index)=>{
                return(
                    <div key={index} className='max-w-xs sm:w-[250px] bg-[#FDFDFE] rounded-lg shadow-lg border border-gray-100 p-8 m-4 cursor-pointer hover:-translate-y-1 transition-all duration-300'
